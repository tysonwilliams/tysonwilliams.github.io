 ...
 *
 */
function EventHubManagementClient(credentials, subscriptionId, baseUri, options) {
  ...
  EventHubManagementClient['super_'].call(this, credentials, options);
...
util.inherits(EventHubManagementClient, ServiceClient);
