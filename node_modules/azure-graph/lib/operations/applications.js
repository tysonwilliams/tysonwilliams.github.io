 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Applications.prototype.updateKeyCredentials = function (applicationObjectId, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Applications.prototype.updatePasswordCredentials = function (applicationObjectId, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
