 ...
 *
 */
function ServiceBusManagementClient(credentials, subscriptionId, baseUri, options) {
  ...
  ServiceBusManagementClient['super_'].call(this, credentials, options);
...
util.inherits(ServiceBusManagementClient, ServiceClient);
